        ...
        <nav className="mt-4">
          <ul className="flex space-x-4">
            <li>
              <Link
                href="/"
                className="w-full md:w-auto px-4 md:px-6 py-2 md:py-3 text-yellow-dark font-bold border-2 border-brown-dark bg-brown rounded-lg hover:bg-yellow-dark hover:text-brown-dark transition"
              >
                Home
              </Link>
            </li>
